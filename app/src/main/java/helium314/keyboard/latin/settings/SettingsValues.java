...
public class SettingsValues {
    ...
    public final boolean mShowsAutoTranslateKey;
    ...
    public SettingsValues(final Context context, final SharedPreferences prefs, final Resources res,
        ...
        mShowsAutoTranslateKey = prefs.getBoolean(Settings.PREF_SHOW_AUTO_TRANSLATE_KEY, Defaults.PREF_SHOW_AUTO_TRANSLATE_KEY);
